...
exports.includes.person = function anonymous(locals) {
    ...
    with (locals || {}) {
        buf.push('<li class="person"><img' + jade.attrs({
            width: "40",
            height: "40",
            src: person.avatar(person.fullName, 40),
            "class": "avatar"
        }, {
            width: true,
            height: true,
...
exports.pages.person = function anonymous(locals) {
    ...
    with (locals || {}) {
        buf.push('<div id="person" class="page"><img' + jade.attrs({
            src: person.avatar(person.fullName, 200),
            width: "200",
            height: "200",
...
// waiting.jade compiled template
exports.waiting = function anonymous(locals) {
    var buf = [];
    with (locals || {}) {
        buf.push('<div class="overlay"><div class="overlay_message"><div class="spinner"><div class="bar1"></div><div class="bar2"></div><div class="bar3"></div><div class="bar4"></div><div class="bar5"></div><div class="bar6"></div><div class="bar7"></div><div class="bar8"></div><div class="bar9"></div><div class="bar10"></div><div class="bar11"></div><div class="bar12"></div></div><strong>' + jade.escape((jade.interp = locals.message) == null ? "" : jade.interp) + "&hellip;</strong></div></div>");
    }
    return buf.join("");
};
